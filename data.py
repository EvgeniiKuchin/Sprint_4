...
user_1 = User(MainPageLocators.button_order_up,
                  "Черкизовская", "Евгений", "Кучин",
                  "Москва, Щёлковское ш., 3 строение 5", "84957776699",
                  "22.05.2023", 3, 1, "Домофон не работает, необходимо будет позвонить перед подъездом")


user_2 = User(MainPageLocators.button_order_down,
                  "Саларьево", "Жанна", "Кучина",
                  "Москва,  Радужный пр., д. 2 кв 10 ", "+79779876543",
                  "10.10.2023", 4, 0, "Привозите после 12:00")
